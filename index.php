            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer_widget">
                    <a class="navbar-brand" href="">
                        YASH<span style = "color:#04DBC0">BoSS</span>&nbsp;CarRental
                    </a>
                    <p>
                        Getting dressed up and traveling with good friends makes for a shared, unforgettable experience.
                    </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer_widget">
                    ...
                    <ul class = "contact_info">
                        <li>
                            <i class="fas fa-map-marker-alt"></i>PIET, ISI-2, sitapura(jaipur).
                        </li>
                        <li>
                            <i class="far fa-envelope"></i>contact@ydarji30@gmail.com
                        </li>
                        <li>
                            <i class="fas fa-mobile-alt"></i>+91 7597660750
                        </li>
                    </ul>
                </div>
            </div>
